var completeCastListing = {
  ...
  "Pepper Potts": {
    ...
    "movies": ["Iron Man", "Iron Man 2", "Avengers: Infinity War"]
  },
  "Bruce Banner / Hulk": {
  ...
  "Natasha Romanoff / Black Widow": {
    ...
    "movies": ["The Avengers", "Captain America: The Winter Soldier", "Avengers: Age of Ultron", "Captain America: Civil War", "Avengers: Infinity War", "Avengers: Endgame"]
  },
  "Clint Barton / Hawkeye": {
    ...
    "movies": ["The Avengers", "Avengers: Age of Ultron", "Captain America: Civil War"]
  },
  "Loki": {
    "actors": ["Tom Hiddleston"],
    "character": "Loki",
    "description": "Thor's adopted brother, based on the Norse mythological deity of the same name.[38]",
    "movies": ["The Avengers", "Thor: The Dark World", "Thor: Ragnarok", "Avengers: Infinity War"]
  },
  "Phil Coulson": {
    "actors": ["Clark Gregg"],
  ...
  "Virginia \"Pepper\" Potts": {
    ...
    "description": "Stark's fiancée and the CEO of Stark Industries,[22] who will wear a powered exosuit of armor in the film.[25] This will be Paltrow's final major appearance as Potts in the MCU.[26]",
    "movies": ["Iron Man 3", "Avengers: Endgame"]
  },
  "Aldrich Killian": {
    "actors": ["Guy Pearce"],
  ...
  "Happy Hogan": {
    ...
    "description": "Tony Stark's former bodyguard and chauffeur, who now serves as Stark Industries' head of security department. Favreau, who served as both actor and director on the previous two Iron Man films, said participating in the new film was \"like [being] a proud grandfather who doesn't have to change the diapers but gets to play with the baby.\"[31]",
    "movies": ["Iron Man 3"]
  },
  "Trevor Slattery": {
    "actors": ["Ben Kingsley"],
  ...
  "undefined": {
    "actors": ["Kat Dennings", "Bobby Cannavale", "Tip \"T.I.\" Harris", "Wood Harris", "Judy Greer", "David Dastmalchian", "Scott Adkins", "Sean Gunn", "Zendaya", "Lashana Lynch"],
    ...
    "movies": ["Thor: The Dark World", "Ant-Man", "Ant-Man", "Ant-Man", "Ant-Man", "Ant-Man", "Doctor Strange", "Guardians of the Galaxy Vol. 2", "Spider-Man: Homecoming", "Ant-Man and the Wasp", "Ant-Man and the Wasp", "Ant-Man and the Wasp", "Ant-Man and the Wasp", "Captain Marvel"]
  },
  "Volstagg": {
  ...
  "Bucky Barnes / Winter Soldier": {
    ...
    "movies": ["Captain America: The Winter Soldier", "Captain America: Civil War", "Avengers: Infinity War"]
  },
  "Sam Wilson / Falcon": {
  ...
  "James \"Rhodey\" Rhodes / War Machine": {
    ...
    "description": "A former officer in the U.S. Air Force and Avenger who operates the War Machine armor.[15]",
  ...
  "Brock Rumlow / Crossbones": {
    "actors": ["Frank Grillo"],
    "character": "Brock Rumlow / Crossbones",
  ...
  "Harold \"Happy\" Hogan": {
    ...
    "movies": ["Spider-Man: Homecoming", "Avengers: Endgame"]
  },
  "Aaron Davis": {
  ...
  "Supreme Intelligence": {
    ...
    "character": "Supreme Intelligence",
