      ...
      <div id="root">
        ...
        <main className="character-details-hidden hawkeye-details">
          <div>
            ...
            <p>A master archer allied with Rogers;[6][7] a retired Avenger and S.H.I.E.L.D. agent.[13][33] On Barton's
              reasons
              ...
              Barton fit into the Marvel Cinematic Universe, Renner said, "I'm happy to be the ensemble. I'm not scratching
              or
        ...
        <main className="character-details-hidden nick-fury-details">
          <div>
            ...
            <p>The future director of S.H.I.E.L.D., who at this time is a low-level bureaucrat.[21] Fury appears without his
              ...
              films.[24] Jackson described Fury at this point in time as a desk jockey, who has not yet become cynical
              towards
              bureaucracy and who learns in the film that there are superpowered beings who could help S.H.I.E.L.D.'s
              cause.[25] Jackson added that trusting Danvers plays a key role in his development, as they become
              "compatriots"
              over the course of the film.[26] Jackson was digitally de-aged by 25 years, the first time Marvel has done
              this
        ...
        <main className="character-details-hidden phil-coulson-details">
          <div>
            ...
            <p>A rookie agent of S.H.I.E.L.D. who works closely with Fury.[21] Gregg stated that Coulson would be younger in
              ...
              television series, Agents of S.H.I.E.L.D., Schwartz stated that in Captain Marvel, Kree is not even "part of
              his
        ...
        <main className="character-details-hidden captain-america-details">
          <div>
            ...
            <p>A fugitive superhero and leader of a faction of Avengers. A World War II veteran, he was enhanced to the peak
              ...
              world.[5] Although the film was beyond Evans' initial six-film contract with Marvel which would have ended
              with
              Avengers: Infinity War, Evans agreed to appear in the film "because it made sense. It's going to wrap
              everything
              up."[6]</p>
            <article>
              <section>
        ...
        <main className="character-details-hidden thor-details">
          <div>
            <h2>Thor</h2>
            <p>An Avenger and the king of Asgard, based on the Norse mythological deity of the same name.[5] Thor now wields
              a
